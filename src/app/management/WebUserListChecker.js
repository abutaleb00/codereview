...
let xx = [];
export class WebUserListChecker extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loaderShow: false,
        ...
        options: {
          ...
          customBodyRender: (value) => {
            return (
              <div>
                {value === "Checker Admin" ? (
                  <span className="badge badge-success">Checker Admin</span>
                ) : value === "Maker" ? (
                  <span className="badge badge-primary">Maker</span>
                ) : value === "Checker" ? (
                  <span className="badge badge-success">Checker</span>
                ) : value === "Maker Admin" ? (
                  <span className="badge badge-primary">Maker Admin</span>
                ) : (
...
export default WebUserListChecker;
