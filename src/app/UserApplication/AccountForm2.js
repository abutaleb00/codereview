...
class AccountForm2 extends Component {
        ...
        .then((res) => {
          if (res.data.result.error === false) {
            this.setState({ ...res.data.data, loaderShow: false }, () => {
              ...
              //console.log("first", JSON.stringify(res.data.data));
            });
          }
        })
    ...
    if (this.state.documentDetailList !== null) {
      this.state.documentDetailList?.map((v) => {
        ...
        if (Number(v?.documentType) === DOCUMENTCHECKLIST.PHOTO.value) {
          ...
          console.log("signature2", v.base64Content);
        } else if (
  ...
  // convertDocumentLists = () => {
  //   console.log("ddd", this.state.documentDetailList);
  //   if (this.state.documentDetailList !== null) {
  //     this.state.documentDetailList.map((v) => {
  //       if (
  //         v !== null &&
  ...
  //             if (Number(v.documentType) === DOCUMENTCHECKLIST.PHOTO.value) {
  //               this.setState({ customerPhoto: v.base64Content });
  //               console.log("image", v.base64Content);
  //             } else if (
  //               Number(v.documentType) === DOCUMENTCHECKLIST.SIGNATURE.value
  //             ) {
  //               this.setState({ customerSignature: v.base64Content });
  ...
  //             if (Number(v.documentType) === DOCUMENTCHECKLIST.PHOTO.value) {
  //               this.setState({ customerPhoto: v.base64Content });
  //               console.log("image p", this.state.customerPhoto);
  //             } else if (
  //               Number(v.documentType) === DOCUMENTCHECKLIST.SIGNATURE.value
  //             ) {
  //               this.setState({ customerSignature: v.base64Content });
  ...
  //     console.log("cus photo", this.state.customerPhoto);
  //   }
  // };
  ...
  render() {
            ...
            >
              {
                ...
                this.state.customerPhoto === null ? (
                  ...
                  <Image
                    ...
                    // src={`data:image/jpeg;base64,${this.state.customerPhoto}`}
                  />
                )
                // (
                //   <Text
    ...
    return (
      <div>
        <PDFDownloadLink document={<MyDoc />} fileName="customer-form.pdf">
